...
**Key Features:**
- **Product Catalog**: Browsable by car manufacturer and model, with QR code generation.
- **Video Library**: Public tutorial videos and internal, sector-based training videos.
- **User Authentication**: JWT-based, role-based access control (admin, supervisor, vendedor_interno, instalador) with Next.js middleware.
